...
INSERT INTO "new_ImportRow" ("errors", "id", "importJobId", "rawData", "rowNumber", "shopifyOrderId", "status") SELECT "errors", "id", "importJobId", "rawData", "rowNumber", "shopifyOrderId", "status" FROM "ImportRow";
